...
export const Blog = () => {
  ...
  return (
    <>
      <SEO 
        title="Blog | Firephin - Financial Planning Insights"
        description="Expert insights on financial planning, investing, retirement planning, and building wealth. Learn how to use Firephin and improve your financial future."
        keywords="financial planning blog, investing tips, retirement planning, wealth building, financial education"
        ogImage="https://firephin.com/og-image.jpg"
        canonicalUrl="https://firephin.com/blog"
      />
